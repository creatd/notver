...
<asp:Panel ID="pnlYorumlar" runat="server" Visible="true" CssClass="hocaYorumlar">
    ...
    <asp:Repeater runat="server" ID="repeaterYorumlar" OnItemDataBound="repeaterYorumlar_ItemDataBound">
        <ItemTemplate>
                <table style="font-weight:bold; color:#505050; padding:10px; background-color:#E6E6E6; width:100%;">
                    <tr>    
                        ...
                        <td style="padding:10px; width:270px; text-align:right;">
                            <asp:UpdatePanel runat="server" ID="pnlSevSevme">
                                <ContentTemplate>
                                    ...
                                    <asp:ImageButton runat="server" ID="yorumSev" Text="Sevdim" OnClick="yorumSev_click" ImageUrl="~/App_Themes/Default/Images/thumbsup.png" ToolTip="Sevdim"></asp:ImageButton>
                                    <asp:ImageButton runat="server" ID="yorumSevme" Text="Sevmedim" OnClick="yorumSevme_click" ImageUrl="~/App_Themes/Default/Images/thumbsdown.png" ToolTip="Sevmedim"></asp:ImageButton>
                                    <br />
