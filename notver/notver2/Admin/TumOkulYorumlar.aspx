...
<br />
    ...
    <asp:DataGrid ID="gridOkulYorumlar" runat="server" AllowPaging="true" AllowSorting="true"
        ...
        <Columns>
            <asp:BoundColumn DataField="OKULYORUM_ID" HeaderText="OkulYorum ID" ReadOnly="true"></asp:BoundColumn>
            ...
            <asp:BoundColumn DataField="YORUM_DURUMU" ItemStyle-CssClass="sakla" HeaderStyle-CssClass="sakla" FooterStyle-CssClass="sakla" ></asp:BoundColumn>
