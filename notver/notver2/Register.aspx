        ...
        <table border="0" style="width:250px;">
            ...
            <tr style="height:66px; vertical-align:top;">
                <td style="padding-left:65px;">
                    <asp:TextBox ID="txtIsim" runat="server" onchange="DurumTemizle();"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtIsim"
